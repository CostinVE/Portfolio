...
const skills: Skill[] = [
  {
    id: 1,
    label: 'CSS/HTML',
    icon: './src/assets/CSS_icon.png', // Replace with the actual path to your icon
  ...
  },
  {
    id: 2,
    label: 'JavaScript',
    icon: './src/assets/JS_icon.png', // Replace with the actual path to your icon
  ...
  },
  {
    id: 3,
    label: 'TypeScript',
    icon: './src/assets/typescript_icon.png', // Replace with the actual path to your icon
  ...
  },
  {
    id: 4,
    label: 'ReactJS',
    icon: './src/assets/react.svg', // Replace with the actual path to your icon
  ...
  },
  {
    id: 5,
    label: 'REST API',
    icon: './src/assets/RestApi.gif', // Replace with the actual path to your icon
  ...
  },
  {
    id: 6,
    label: 'GraphQL',
    icon: './src/assets/graphql_icon.png', // Replace with the actual path to your icon
...
const skills2: Skill[] = [
  ...
  },
  {
    id: 4,
    label: 'NodeJS',
    icon: './src/assets/nodejs-logo.svg',
...
const skills3: Skill[] = [
  ...
  },
  {
    ...
    icon: './src/assets/MicrosoftOffice.png',
